 ...
 *
 * Frames are binary WebSocket messages. Byte 0 is the type; types below 0x20 carry a
 * UTF-8 JSON body, types at or above 0x20 carry a u32 big-endian stream id followed by
